...
export function WelcomeScreen({ onContinueAction }: { onContinueAction: () => void }) {
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-linear-to-br from-gov-950 via-gov-900 to-gov-800 p-4">
      <div className="w-full max-w-md animate-fade-in flex flex-col items-center text-center">
        ...
        <h1 className="mt-8 text-3xl font-bold text-white leading-tight">{t('title')}</h1>
        <p className="mt-3 text-sm text-gov-300 leading-relaxed max-w-sm">{t('subtitle')}</p>
