...
export function NewMiniAppCard({ newModule }: MiniAppCardProps) {
  ...
  // Only the floating chat app is permitted for guests; every other app
  // shows the "Login required" modal instead of navigating.
  const isChatApp = newModule.miniAppId === FLOATING_MINI_APP_ID;
    ...
    <>
      <button
        ...
        onClick={(e) => {
          ...
          router.push(`/${newModule.miniAppId}?source=registry`);
        }}
        type="button"
      >
